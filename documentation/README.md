...
Use this index to quickly find the right document type.

## Canonical (Start Here)

- `documentation/ARCHITECTURE.md` - Navigation map: core flow, folder responsibilities, what must never happen, change recipes.
- `documentation/00-project-specs.md` - Source-of-truth API and architecture spec.
...
Historical implementation plans, review responses, and build outputs are in:

- `documentation/archive/README.md`
- `documentation/archive/2026-02/`

Archive content is retained for context and audit trail, but should not be treated as current source-of-truth unless explicitly referenced by an active doc.
