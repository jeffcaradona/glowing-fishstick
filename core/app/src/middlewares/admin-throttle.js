 ...
 * for admin-facing routes. Returns 429 when the request count for a given
 ...
 * config reads, API health probes). Throttling prevents burst-driven
 * resource exhaustion without requiring external state (Redis).
 *
 ...
 *
 * VERIFY IF CHANGED: Integration tests for 429 responses on admin routes,
