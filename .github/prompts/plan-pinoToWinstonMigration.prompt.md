...
- **Maintenance branch**: `maintenance/0.1.x` is cut from the last `0.1.8` release commit _before_ any 0.2.0 work merges to `main`. Pino-era security and severe-bug backports land there. See `RELEASING.md` → "Maintenance branches" for the workflow and sunset policy.
